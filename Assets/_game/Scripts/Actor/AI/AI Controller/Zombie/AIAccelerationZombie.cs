...
namespace Spicyy.AI
{
    public class AIAccelerationZombie : MobileAI, IEnemy
    {
        ...
        [Title("ACCELERATION", titleAlignment: TitleAlignments.Centered)]
        [SerializeField] private float distanceAccel;
        ...
        protected override void Init()
        {
            ...
            m_Animator.SetBool("Crawling", false); 
        }
        ...
        protected override void Move(Transform target)
        {
            ...
            if (direction.magnitude <= distanceAccel)
            {
                m_Animator.SetBool("Crawling", true);
            }
            else
            {
                m_Animator.SetBool("Crawling", false);
