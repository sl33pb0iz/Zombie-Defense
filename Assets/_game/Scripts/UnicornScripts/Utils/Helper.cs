...
namespace Unicorn.Utilities
{
    ...
    {
        public const string ChangeableUsername = "FirstTimeOpenApplication";
        public const string Username = "Username";

        public const string CurrentFloorInBunker = "CurrentFloorInBunker";
        ...
        public const string DataDefalutSkin = "DataDefaultSkin";

        public const string PlayerHealthLevel = "PlayerHealthLevel";
        public const string PlayerAttackLevel = "PlayerAttackLevel";
        public const string PlayerDefenseLevel = "PlayerDefenseLevel";

        public const string PlayerTotalATK = "PlayerTotalATK";
        public const string PlayerTotalHealth = "PlayerTotalHealth";
        public const string PlayerTotalDefense = "PlayerTotalDefense";
        ...
        public const string inter_mid_game = "inter_mid_game";
        ...
        public const string video_upgrade_player = "video_upgrade_player";
        public const string video_cast_player_skill = "video_cast_player_skill";
        

        public const string SoundSetting = "SoundSetting";
        public const string MusicSetting = "MusicSetting";
        public const string VibrateSetting = "VibrateSetting";
